(function() {
  ...
  function openFile() {
    ...
    reader.onload = function(event) {
      ...
      function importText() {
        ...
        editor.innerHTML = normalizeFile(splitByParagraph);
      }
      ...
      function importMarkdown() {
        editor.innerHTML = normalizeFile(converter.makeHtml(fileContent));
      }
  ...
  function clearUnacceptedTags(node) {
    var elems = Array.from(node.getElementsByTagName("*"));
    elems.forEach(el => {
  ...
  document.addEventListener("keydown", (event) => {
    ...
    if (editor.contains(event.target)) {
      switch (keys) {
        case "ctrl + s": // Save to local file
          event.preventDefault();
          exportFileDialog();
          break;

        case "ctrl + o": // Open local file
          event.preventDefault();
          document.getElementById("file-item").click();
          break;

        case "ctrl + b": // Bold text
          event.preventDefault();
          document.execCommand("bold", false, null);
          break;

        case "ctrl + i": // Italicize text
          event.preventDefault();
          document.execCommand("italic", false, null);
          break;

        case "ctrl + 0": // Add paragraph
          event.preventDefault();
          document.execCommand("formatBlock", false, "<p>");
          break;

        case "ctrl + 1": // Add heading 1
          event.preventDefault();
          document.execCommand("formatBlock", false, "<h1>");
          break;

        case "ctrl + 2": // Add heading 2
          event.preventDefault();
          document.execCommand("formatBlock", false, "<h2>");
          break;

        case "ctrl + 3": // Add heading 3
          event.preventDefault();
          document.execCommand("formatBlock", false, "<h3>");
          break;

        case "ctrl + 4": // Add heading 4
          event.preventDefault();
          document.execCommand("formatBlock", false, "<h4>");
          break;

        case "ctrl + u": // Add underline - unlisted
          event.preventDefault();
          document.execCommand("underline", false, null);
          break;

        case "ctrl + k": // Add link
          event.preventDefault();
        ...
        case "ctrl + \\":
          event.preventDefault(); // Clear formatting - unlisted
          document.execCommand("removeFormat", false, null);
          break;

        case "ctrl + alt + -": // Strikethrough text - unlisted
          event.preventDefault();
          document.execCommand("strikeThrough", false, null);
          break;

        case "ctrl + shift + <": // Add subscript - unlisted
          event.preventDefault();
          document.execCommand("subscript", false, null);
          break;

        case "ctrl + shift + >": // Add superscript - unlisted
          event.preventDefault();
          document.execCommand("superscript", false, null);
          break;

        case "ctrl + shift + l": // Add numbered list
          event.preventDefault();
          document.execCommand("insertOrderedList", false, null);
          break;

        case "ctrl + alt + l": // Add bulleted list
          event.preventDefault();
        ...
        case "ctrl + alt + s": // Add sidenote
          event.preventDefault();
          let selectionInSidenote = false;
          Array.from(document.getElementsByTagName("small")).forEach((node) => {
            if (window.getSelection().containsNode(node, true)) {
              selectionInSidenote = true;
            }
          });
          if (selectionInSidenote === false) {
            document.execCommand("insertHTML", false, "<small>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</small>");
          }
          break;
